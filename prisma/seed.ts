...
const prismaCourse = prisma.course.createMany({
	data: [
		...
		{
			code: "CS0048",
			name: "CS Specialization 1 (Structured Programming Language) Lec",
			departmentId: 1,
			courseTypeId: 1,
			yearLevelId: 2,
			termId: 3,
		...
		{
			code: "CS0048L",
			name: "CS Specialization 1 (Structured Programming Language) Lab",
			departmentId: 1,
			courseTypeId: 2,
			yearLevelId: 2,
			termId: 3,
		...
		{
			code: "CS0061",
			name: "CS Specialization 4 - Business Process for Computing Lec",
			departmentId: 1,
			courseTypeId: 1,
			yearLevelId: 3,
			termId: 3,
		...
		{
			code: "CS0061L",
			name: "CS Specialization 4 - Business Process for Computing Lab",
			departmentId: 1,
			courseTypeId: 2,
			yearLevelId: 3,
			termId: 3,
