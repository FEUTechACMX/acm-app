			...
			<div className="flex items-center">
				...
				<div className="flex flex-col items-start ml-2 md:ml-4">
					<a
						href={partner.Web}
						target="_blank"
						className="w-9 h-9 bg-coral-pink rounded-full mb-2 my-2 grid place-items-center"
					>
					...
					<a
						...
						target="_blank"
						className="w-9 h-9 bg-coral-pink rounded-full mb-2 grid place-items-center"
					>
						<svg
...
const AlternatingPartnersLayout: React.FC<AlternatingPartnersLayoutProps> = ({
	partners,
}) => {
