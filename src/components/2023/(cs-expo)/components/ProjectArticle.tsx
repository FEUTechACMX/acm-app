			...
			<div className="flex flex-col w-screen pt-24">
				<div className="flex flex-col items-center justify-start pt-5">
					<div className="flex relative bg-timberwolf h-[560px] w-[450px] s-full shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)]">
						<div className="absolute top-[30px] left-[-70px] h-[110px] w-[110px] rounded-full bg-yellow-300"></div>
						<div className="absolute top-[170px] left-[-70px] h-[110px] w-[110px] rounded-full bg-yellow-600"></div>
						<div className="absolute top-[80px] right-[-60px] bg-red-200 h-[250px] w-[250px]"></div>
					</div>
				</div>
				<div className="flex flex-col ml-5 mr-10 my-10">
					<div className="text-4xl font-bold text-end row-start-1">
						{thesisTitle}
					</div>
					<div className="text-3xl font-bold text-end row-start-2 text-coral-pink pt-5">
						{groupname}
					</div>
				</div>
			</div>
				...
				<div className="flex flex-col px-6">
					<div className="flex flex-col">
						...
						<div className="flex flex-col">
							<div className="flex flex-row justify-end w-full bg-timberwolf pb-4 relative">
								...
								<button
									...
									className="flex items-center text-coral-pink font-bold cursor-pointer"
								>
						...
						<div className="grid grid-cols-5 bg-timberwolf gap-3 place-items-stretch">
							<div className="h-[200px] bg-zinc-400 s-full"></div>
							<div className="h-[200px] bg-zinc-400 s-full"></div>
							<div className="h-[200px] bg-zinc-400 s-full"></div>
							<div className="h-[200px] bg-zinc-400 s-full"></div>
							<div className="h-[200px] bg-zinc-400 s-full"></div>
