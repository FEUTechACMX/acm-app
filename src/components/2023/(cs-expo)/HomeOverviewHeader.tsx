...
const EventComponent: React.FC<HomeOverviewHeaderProps> = ({
	title,
	description,
	button,
}) => {
	...
	return (
		<div className="pt-80 align-center mt-80">
			...
			<p className="mt-5 mb-36 flex flex-col items-center font-family-helvetica">
				<a
					href={button}
					className="hover:bg-eerie-black mb-56 text-base bg-coral-pink flex py-4 px-8 lex justify-center items-center text-white"
				>
					View event details
				</a>
			</p>
